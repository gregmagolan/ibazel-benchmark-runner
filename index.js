...
function runBenchmark() {
  ...
  const incrementalTimeout = parseInt(opts.incremental_timeout) || 15;
  ...
  waitForProfilerEvent(profileFilename, 'RUN_DONE', null, initialTimeout * 1000)
      ...
      .then((initialEvent) => {
            ...
            return browser.newPage()
                ...
                .then(
                    () => waitForProfilerEvent(
                        profileFilename, 'REMOTE_EVENT', null, incrementalTimeout * 1000))
          })
        }
        return browserPromise
            ...
            .then(
                () => waitForProfilerEvent(
                    profileFilename, 'RUN_DONE', initialEvent.iteration, 10 * 1000))
            ...
            .then(() => {
              if (browserUrl) {
                return waitForProfilerEvent(
                           profileFilename, 'REMOTE_EVENT', initialEvent.iteration, 10 * 1000)
